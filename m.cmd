...
for %%f in (*.c) do (
    "%VBCC%\vbccm68k" -c99 -warn=-1 -dontwarn=79 -dontwarn=166 -dontwarn=168 -dontwarn=81 -maxerrors=0 -speed -O=1023 -o=out\%%~nf.s %%f || goto :end
)
set objs=
for %%f in (*.s out\*.s) do (
    "%VBCC%\vasmm68k_mot_win32" -phxass -x -Fvobj -o out\%%~nf.o %%f || goto :end
